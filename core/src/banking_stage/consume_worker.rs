...
pub mod external {
    use {
        ...
        agave_scheduler_bindings::{
            ExecutionWorkerToPackMessage, MAX_TRANSACTIONS_PER_MESSAGE,
            PackToExecutionWorkerMessage, TransactionResponseRegion, execution_message_flags,
    ...
    mod tests {
        use {
            ...
            agave_scheduler_bindings::{
                SharableTransactionBatchRegion, processed_codes, worker_message_types,
            },
            agave_scheduling_utils::{
