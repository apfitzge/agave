...
//!
//! At the highest level, this crate takes [`ReplayTransaction`]s via its
...
mod tests {
    ...
    fn do_test_scheduler_schedule_execution_failure(extra_tx_after_failure: bool) {
        ...
        let bad_tx = ReplayTransaction::from_transaction_for_tests(system_transaction::transfer(
            &unfunded_keypair,
            &solana_pubkey::new_rand(),
            2,
            genesis_config.hash(),
    ...
    fn test_scheduler_schedule_execution_blocked_at_session_ending() {
        ...
        let tx1 = ReplayTransaction::from_transaction_for_tests(system_transaction::transfer(
            &mint_keypair,
            &solana_pubkey::new_rand(),
            2,
            genesis_config.hash(),
    ...
    fn test_scheduler_mismatched_scheduling_context_race() {
        ...
        let dummy_tx = ReplayTransaction::from_transaction_for_tests(system_transaction::transfer(
            &mint_keypair,
            &solana_pubkey::new_rand(),
            2,
            genesis_config.hash(),
    ...
    fn test_enfoced_get_account_locks_validation() {
        ...
        let tx = ReplayTransaction::from_transaction_for_tests(tx);
